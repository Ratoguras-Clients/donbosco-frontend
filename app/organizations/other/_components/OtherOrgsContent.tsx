...
import { Search, Inbox, Calendar, Globe } from "lucide-react";
import type { OtherOrganization } from "@/lib/types";

interface Props {
  organizations: OtherOrganization[];
}

export function OtherOrgsContent({ organizations }: Props) {
      ...
      <div className="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        >
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search other organizations..."
              value={search}
        ...
        <p className="text-sm text-text-muted mb-8">
          ...
          other {filtered.length === 1 ? "organization" : "organizations"}
        </p>
